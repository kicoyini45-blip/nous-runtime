...
- `hello_workflow/` — minimal registered Workflow definition.
...
Examples use synthetic identifiers and no real credentials. Run them only in a temporary workspace and remove generated Runtime state after evaluation.
